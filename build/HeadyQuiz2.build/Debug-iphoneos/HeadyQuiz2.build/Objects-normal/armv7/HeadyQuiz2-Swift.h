...
SWIFT_CLASS("_TtC10HeadyQuiz211AppDelegate")
...
SWIFT_CLASS_NAMED("Records")
@interface Records : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface Records (SWIFT_EXTENSION(HeadyQuiz2))
@property (nonatomic, copy) NSString * _Nullable answer1;
@property (nonatomic, copy) NSString * _Nullable answer2;
@property (nonatomic, copy) NSString * _Nullable answer3;
@property (nonatomic, copy) NSString * _Nullable answer4;
...
SWIFT_CLASS("_TtC10HeadyQuiz214ViewController")
...
@property (nonatomic, copy) NSString * _Nonnull answer3value;
@property (nonatomic, copy) NSString * _Nonnull answer4value;
